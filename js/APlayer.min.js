!function (e, t) {
  'object' == typeof exports && 'object' == typeof module ? module.exports = t()  : 'function' == typeof define && define.amd ? define('APlayer', [
  ], t)  : 'object' == typeof exports ? exports.APlayer = t()  : e.APlayer = t()
}(window, function () {
  return function (e) {
    var t = {
    };
      ...
      return i(e, [
        {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              '[object Array]' !== Object.prototype.toString.call(e) && (e = [
                e
              ]),
              e.map(function (e) {
              ...
              }), this.audios = this.audios.concat(e), t && this.audios.length > 1 && this.player.container.classList.add('aplayer-withlist'), this.player.randomOrder = r.default.randomOrder(this.audios.length),
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (this.player.events.trigger('listswitch', {
                        ...
                        (0, o.default) (33 * this.index, 500, null, this.player.template.listOl), this.player.setAudio(t), this.player.lrc && this.player.lrc.switch (this.index),
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        t = function (t) {
                          ...
                          n), document.removeEventListener(a.default.nameMap.dragMove,
                          t); var r = ((i.clientX || i.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.barWrap)) / e.player.template.barWrap.clientWidth; r = Math.max(r, 0), r = Math.min(r, 1), e.player.bar.set('played', r, 'width'), e.player.seek(e.player.bar.get('played', 'width') * e.player.duration), e.player.disableTimeupdate = !1
                        }; this.player.template.barWrap.addEventListener(a.default.nameMap.dragStart,
                        function () {
                          e.player.disableTimeupdate = !0,
                          document.addEventListener(a.default.nameMap.dragMove,
                          t), document.addEventListener(a.default.nameMap.dragEnd,
                          n)
                        })
                      }
                    }, {
                      ...
                      value: function () {
                        ...
                        var t = function (t) {
                          var n = 1 - ((t.clientY || t.changedTouches[0].clientY) - a.default.getElementViewTop(e.player.template.volumeBar, e.player.options.fixed)) / e.player.template.volumeBar.clientHeight; n = Math.max(n, 0), n = Math.min(n, 1), e.player.volume(n)
                        },
                        n = function n(i) {
                          e.player.template.volumeBarWrap.classList.remove('aplayer-volume-bar-wrap-active'),
                          document.removeEventListener(a.default.nameMap.dragEnd,
                          n), document.removeEventListener(a.default.nameMap.dragMove,
                          t); var r = 1 - ((i.clientY || i.changedTouches[0].clientY) - a.default.getElementViewTop(e.player.template.volumeBar, e.player.options.fixed)) / e.player.template.volumeBar.clientHeight; r = Math.max(r, 0), r = Math.min(r, 1), e.player.volume(r)
                  ...
                  var s = function () {
                          ...
                          if (e) {
                            for (var t = (e = e.replace(/([^\]^\n])\[/g, function (e, t) {
                              ...
                              if (r) for (var s = r.length, l = 0; l < s; l++) {
                                ...
                                c = 60 * u[1] + parseInt(u[2]) + (u[4] ? parseInt(u[4]) / (2 === (u[4] + '').length ? 100 : 1000)  : 0);
                                n.push([c,
                                o])
                              }
                            }
                    ...
                    var s = function () {
                      function e(t) {
                        ...
                        this.data = JSON.parse(o.default.storage.get(this.storageName)), this.data || (this.data = {
                    ...
                    function (e, t, n) {
                      ...
                      function (e, t, n) {
                        ...
                        t.default = function (e) {
                          ...
                          return '[object Array]' !== Object.prototype.toString.call(e.audio) && (e.audio = [
                            e.audio
                          ]),
                      ...
                      function (e, t, n) {
                        ...
                        g = function () {
                          function e(t) {
                            if (function (e, t) {
                              if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function')
                            }(this, e), this.options = (0, s.default) (t), this.container = this.options.container, this.paused = !0, this.playedPromise = a.default.resolve(),
                            this.mode = 'normal',
                            ...
                            2 === this.options.lrcType || !0 === this.options.lrcType) for (var n = this.container.getElementsByClassName('aplayer-lrc-content'), i = 0; i < n.length; i++) this.options.audio[i] && (this.options.audio[i].lrc = n[i].innerHTML);
                                    ...
                                    'none' === e.options.loop ? 'list' === e.options.order ? e.list.index < e.list.audios.length - 1 ? (e.list.switch ((e.list.index + 1) % e.list.audios.length),
                                      e.play()) : (e.list.switch ((e.list.index + 1) % e.list.audios.length),
                                        e.pause()) : 'random' === e.options.order && (e.randomOrder.indexOf(e.list.index) < e.randomOrder.length - 1 ? (e.list.switch (e.nextIndex()),
                                          e.play()) : (e.list.switch (e.nextIndex()),
                                            e.pause())) : 'one' === e.options.loop ? (e.list.switch (e.list.index),
                                              e.play()) : 'all' === e.options.loop && (e.skipForward(), e.play())
                                            })
                                          }
                                        }, {
                                          key: 'setAudio',
                                        ...
                                        },
                                        {
                                          ...
                                          value: function () {
                                            this.volume() >= 0.95 ? this.template.volumeButton.innerHTML = o.default.volumeUp:
                                        ...
                                        },
                                        {
                                          ...
                                          },
                                          {
                                            ...
                                            value: function (e) {
                                              var t = this,
                                              n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2000,
